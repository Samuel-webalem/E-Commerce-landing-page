...
<header>
  <div class="left">
    ...
    <svg width="16" class="menu" height="15" xmlns="http://www.w3.org/2000/svg"
      on:click="{displayercatagory}"><path
...
{/if}
{#if catagory}
  <Hamburger on:close={displayercatagory}><div>
      <h2>Collection</h2>
      <h2>Men</h2>
      <h2>Women</h2>
      <h2>About</h2>
...
<style>
  ...
  header {
    ...
    border-bottom: 2px inset hsl(220, 14%, 75%);
    padding: 0 0 10px 0;
    height: 80px;
  }
